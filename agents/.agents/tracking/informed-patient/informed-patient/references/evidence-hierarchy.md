...
**Watch for:** Guidelines age badly. A guideline more than 5 years old may not reflect current evidence, so always check whether an update has been issued. Quality also varies: the best guidelines use GRADE methodology to explicitly rate the evidence behind each recommendation; others are based primarily on expert consensus with limited transparency. Check whether the guideline reports its evidence-grading methodology. **Always flag guidelines older than 5 years with ⚠️.**
